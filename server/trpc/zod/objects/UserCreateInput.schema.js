...
exports.UserCreateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), email: zod_1.z.string(), posts: zod_1.z.lazy(() => PostCreateNestedManyWithoutAuthorInput_schema_1.PostCreateNestedManyWithoutAuthorInputObjectSchema).optional()
}).strict();

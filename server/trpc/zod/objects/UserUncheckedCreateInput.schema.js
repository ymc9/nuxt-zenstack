...
exports.UserUncheckedCreateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), email: zod_1.z.string(), posts: zod_1.z.lazy(() => PostUncheckedCreateNestedManyWithoutAuthorInput_schema_1.PostUncheckedCreateNestedManyWithoutAuthorInputObjectSchema).optional()
}).strict();
